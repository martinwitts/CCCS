...
#--------------------------------------------------------------------------Current Carrying Capacities           
            ...
            my ($Ib, $In, $pscc, $z, $method, $length, $dev_maxzs, $dev_type, $use, $ring) = collect(\@ref_list);
            say "Ib is :" . $Ib;
            say "Max Zs for Device is :" . $dev_maxzs;
            say "In chosen for Device is :" . $In;
            say "Length is :" . $length;
            say "Method is :" . $method;
            say "Ze of supply is :" . $z;
            say "Max PSCC for supply is :" . $pscc;
            say "Device type is :" . $dev_type;
            say "use is :" . $use;
            say "Radial / Ring :" . $ring;   
			...
			return ($fini_zs, $fini, $method, $drop, $perc, $dev_maxzs, $Ib, $z, $length, $pscc, $In, $use, $ring);
            #End
sub vdrop{
...
sub collect{
  ...
  #---------------------------------------
  say "What is the prospective short circuit current? ";
  my $pscc = <STDIN>;
  chomp $pscc;
  my $dev_type;
    if ($pscc <= 6) {
  ...
  return ($IB, $In, $pscc, $z, $method, $length, $dev_maxzs, $dev_type, $use, $ring);
